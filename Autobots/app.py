...
st.markdown('<div class="subtitle">Light, Lovely & Bowed-Up for Hackathon Glory!</div>', unsafe_allow_html=True)

# Bow GIF
st.markdown('<div class="bow"><img src="https://i.imgur.com/S2wP4RI.gif" width="100"></div>', unsafe_allow_html=True)

# Sidebar
st.sidebar.image("https://i.imgur.com/O2gIww3.png", use_container_width=True)
